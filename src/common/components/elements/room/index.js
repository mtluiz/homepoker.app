  ...
  return (
    <div className="">
      <header className='flex justify-center'>
        <a href='/' className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center absolute top-8 left-8" >
      ...
      <VoteCards clickOnCard={clickOnVoteCard} type={roomSocketInfo.type} />
    </div>
  )
}
