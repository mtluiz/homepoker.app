...
export default function Room({ roomId, roomSocketInfo, clickOnVoteCard }) {
  ...
  return (
    <div className="">
      ...
      <header className='flex justify-center'>
        ...
        <button className="bg-white hover:bg-blue-100 text-blue-600 font-bold py-2 px-4 rounded inline-flex items-center text-1xl" onClick={() => { copyToClipboard(roomId) }}>
      ...
      <div className='actions flex justify-center my-8 w-full gap-12'>
        <button className='text-1xl text-white border-solid shadow-xl bg-blue-600 hover:bg-blue-500 transition-all py-2 px-4 rounded inline-flex items-center'>
