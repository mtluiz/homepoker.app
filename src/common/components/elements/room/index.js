  ...
  return (
    <div className="">
      ...
      <div className='actions flex justify-center my-8 w-full gap-12'>
        <button className='text-2xl text-white border-solid shadow-xl bg-blue-600 hover:bg-blue-500 transition-all py-2 px-4 rounded inline-flex items-center'>
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-eye mr-2" viewBox="0 0 16 16">
        ...
        <button className='text-2xl text-white border-solid shadow-xl bg-blue-600 hover:bg-blue-500 transition-all py-2 px-4 rounded inline-flex items-center'>
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-arrow-counterclockwise mr-2" viewBox="0 0 16 16">
